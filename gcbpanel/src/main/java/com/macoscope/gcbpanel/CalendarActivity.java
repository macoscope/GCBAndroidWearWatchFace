...
public class CalendarActivity extends Activity implements EasyPermissions.PermissionCallbacks {
    ...
    static final String CALENDAR_ID = "macoscope.net_lskbc00114g54jr1mrn8fis1qk@group.calendar.google.com";
    static final int CALENDAR_MAX_EVENTS = 10;
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            ...
            Events events = mService.events().list(CALENDAR_ID)
                    .setMaxResults(CALENDAR_MAX_EVENTS)
                    .setTimeMin(now)

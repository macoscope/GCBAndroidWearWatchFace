...
public class CalendarEvent implements Comparable<CalendarEvent> {
     ...
     * @param hourRange number of hours from now
     * Notes: from my observation, only 24 hours of calendar are downloaded to wear-side; specifying more than 24 hours is useless.
    ...
    public static ArrayList<CalendarEvent> getNextEvents(Context context, long calendarId, int hourRange) {
        ...
        while (cursor.moveToNext()) {
            ...
            //  ...filter out events w/ past start time
            //  ...Because the query will include current events that have start time is the past.

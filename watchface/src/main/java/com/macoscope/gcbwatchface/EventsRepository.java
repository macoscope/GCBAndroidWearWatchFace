...
public class EventsRepository {
    ...
    private static final String CALENDAR_SELECTION = Calendars._ID + " = ?s";
    ...
    private static final String INSTANCE_SELECTION = Instances.CALENDAR_ID + " = ?s" +
    ...
    public void logCalendarsDisplayName() {
//        Uri uri = WearableCalendarContract.CONTENT_URI;
...
//        cursor.close();
    ...
    public Optional<List<EventModel>> getEvents(int calendarId, long timeInterval, TimeUnit timeUnit) {
        Uri.Builder eventsUriBuilder = WearableCalendarContract.Instances.CONTENT_URI.buildUpon();
        ...
        Cursor cursor = contentResolver.query(uri, INSTANCE_PROJECTION, null, null, null);
